...
4. Put the urls and sheet names into the top of `Code.gs`
5. Start a new project on [Google Apps Script](https://script.google.com/home)
6. Copy all the code in `Code.gs` into the new project
7. Run `gmailAutoClean` function in this `Code.gs`
